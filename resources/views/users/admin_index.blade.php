                ...
                <section class="card">
                    ...
                    <div class="card-body">      
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    <th>{{ trans('users/admin_lang.fields.id') }}</th>
                                    <th>{{ trans('users/admin_lang.fields.active') }}</th>
                                    <th>{{ trans('users/admin_lang.fields.display_name') }}</th>
                                    <th>{{ trans('users/admin_lang.fields.description') }}</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a  class="btn btn-info" href="{{ route('admin.users.edit',$user->id) }}" ><i
